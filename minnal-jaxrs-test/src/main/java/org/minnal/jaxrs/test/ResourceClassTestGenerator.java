...
import static org.minnal.instrument.entity.EntityNode.PathVisitor;

public class ResourceClassTestGenerator extends AbstractTemplateGenerator {

    private Class<?> entityClass;

    private List<EntityNode.EntityNodePath> paths = new ArrayList<EntityNode.EntityNodePath>();
    ...
    public void init() {
        ...
        tree.construct();
        tree.traverse(new PathVisitor<EntityNode.EntityNodePath, EntityNode>() {
            @Override
            public void visit(EntityNode.EntityNodePath path) {
                paths.add(path);
            }
        });
        super.init();
    ...
    public void generate() {
        ...
        for (EntityNode.EntityNodePath path : paths) {
    ...
    protected StringWriter createMethod(EntityNode.EntityNodePath path, boolean bulk, String method) throws Exception {
    ...
    protected Template getMethodTemplate(EntityNode.EntityNodePath path, boolean bulk, String method) {
        if (bulk) {
